(function () {
  ...
  var APPS = [
    ...
    { id:3, name:"Helios", cover:"https://cdn.jsdelivr.net/gh/solual/apps/helios/logo.jpg",    url:"https://cdn.jsdelivr.net/gh/solual/apps/helios/index.html", authors:["dinguschan"] },
  ];
